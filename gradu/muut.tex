...
\hld{Vertailuluku, jossa käydään läpi toisessa luvussa määriteltyjä kriteerejä
...
\hld{Kooste verrattavien ohjelmointikielten yhteisistä ominaisuuksista. Koska
...
ajoaikaisesti~\citep{effectivego}. Tällainen tilanne voisi olla esimerkiksi
...
\hld{Tässä aliluvussa tehdään yhteenveto ohjelmointikielten vertailusta, ja
...
Taulukkossa~\ref{table:properties} on yhteenveto verrattavista
