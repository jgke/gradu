...
\hl{poikkeuksellisissa tilanteissa -> selvennä}
...
\begin{figure}[ht!]
    ...
    \begin{minipage}{0.5\textwidth}
        \input{data_purkka/benchmarkscpu.tex}
        \vspace*{-0.8cm}
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \input{data_purkka/benchmarksmem.tex}
        \vspace*{-0.9cm}
    \end{minipage}
    \end{minipage}
    \end{adjustbox}
    ...
    \begin{minipage}{0.5\textwidth}
        \input{data_purkka/benchmarkslines.tex}
    \end{minipage}}
    \end{minipage}
    \end{adjustbox}
    \caption{
