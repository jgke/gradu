...
Luvussa~\ref{sec:results} kerrotaan tarkemmin mittauksista. Tarkat mittausarvot
löytyvät liitteestä~\ref{app:data}. Toisin kuin Benchmarks Gamessa, ennen
lähdekoodin pakkaamista lähdekoodista on poistettu kaikki tyhjämerkit, jotta
lähdekoodin asettelu ei vaikuta mittauksiin. Kuvaajat perustuvat nopeimman
kielellä kirjoitetun ohjelman tuloksiin -- lähes jokaisella verrattavalla
