...
\hld{Tässä luvussa kerrotaan ohjelmointikielten taustoista ja yleisistä
...
\hld{Tässä aliluvussa kerrotaan C-kielen taustasta, alkuperäisistä
...
\hld{Tässä aliluvussa pohditaan, miksi C pitäisi korvata uudella
...
\hld{Näitä ominaisuuksia ovat ainakin tarkempi käännösaikainen tyypitys etenkin
...
C:n tyypitys sallii monia ilmaisuja, jotka voivat johtaa salakavaliin
...
\hld{Jotta kielten vertailun voi tehdä objektiivisesti, valitaan vertailua
...
\hld{Vertailtaviksi kieliksi valitaan Ada, C++, D, Go ja Rust. Kaikki
...
\hld{Analyysiä muista syistä kielen suosioon, erityisesti Meyerovichin ja
...
\hld{Tässä aliluvussa selitetään makrojärjestelmien käsite, kerrotaan
