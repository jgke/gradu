...
\hl{Luvun 2 otsikko ei oikein vastaa sisältöä (miten kielten suosioon
vaikuttavat tekijät liittyvät ohjelmointikielten vertailua koskeviin
määritelmiin?). Parempi otsikko voisi olla ''Järjestelmäohjelmointikielistä''
tai ''Taustaa'' tms.}
...
Jos kieltä käytetään useassa ohjelmassa, tilankäytön kannalta on edullisempaa
...
\hl{C-VFR (?) keksi parempi lyhenne / älä lyhennä tjsp?}

Ohjelmointikielen tulee olla täysin yhteensopiva C:n kanssa. Tämä koskee
C-koodin kutsumista (C-vie\-ras\-funk\-tio\-ra\-ja\-pin\-ta, C-VFR\defword{Foreign
...
\hl{? (alleviivattu: ei ole mahdollista toteuttaa, ovat täysin mahdollisia toteuttaa)}
